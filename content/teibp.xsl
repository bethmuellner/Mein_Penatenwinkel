  ...
  <xsl:template name="grab-css">
	...
	<xsl:template name="teibpToolbox">
		<div id="teibpToolbox">
            ...
            <label for="rsToggle">Highlight locations</label>
            <input type="checkbox" id="rsToggle" />
			<!-- Steve's addition for unclear button -->
			<!--<label for="unclearToggle">Highlight unclear</label>
			<input type="checkbox" id="unclearToggle" />
			-->
			<div>
				<h3>Themes:</h3>
            ...
            <!--Table of contents code added by Doug-->
            <div id="toc"><h3>Contents</h3><i>TOC links only work in Firefox</i>
            	<p></p>
                <script>

                    var headElements = document.getElementsByTagName("head");
                    for (var i = 1; i &lt; headElements.length; i++) {
                        var htmlString = "&lt;a name=\"title" + i + "\"&gt;" + headElements[i].innerHTML + "&lt;/a&gt;";
                        headElements[i].innerHTML = htmlString;
                    }
                </script>
                <a href="#title1">Dialogue</a><br></br>
                <a href="#title2">Table Des Conversations</a><br></br>
                <a href="#title3">Extrait du Privilege</a><br></br>
                <a href="#title4">Des Plaisirs</a><br></br>
                <a href="#title5">De La Connoissance</a><br></br>
                <a href="#title6">Contre Ceux Qui Parlent</a><br></br>
                <a href="#title7">De Parler Trop</a><br></br>
                <a href="#title8">Ceux Qui Decrient</a><br></br>
                <a href="#title9">Des Passions</a><br></br>
                <a href="#title10">De La Complaisance</a><br></br>
                <a href="#title11">Difference Du Flateur</a><br></br>
                <a href="#title12">De La Dissimulation</a>
            </div>
