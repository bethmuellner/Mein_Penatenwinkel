...
function init(){
    ...
    //Code for location highlighting added by Doug
    document.getElementById('rsToggle').onclick = function(){
        if(document.getElementById('rsToggle').checked){
            var myElements = document.getElementsByTagName("rs");
            ...
            var myElements = document.getElementsByTagName("rs");
            for (var i = 0; i < myElements.length; i++) {
                myElements[i].style.backgroundColor = "transparent";
            }
        }
    };
    document.getElementById('rsToggle').checked = false;
    
    
//Steve's unclear checkbox code
// document.getElementById('unclearToggle').onclick = function(){
//         if(document.getElementById('unclearToggle').checked){
//             var myElements = document.getElementsByTagName("unclear");
//             for (var i = 0; i < myElements.length; i++) {
...
//         }
//     };
//     document.getElementById('unclearToggle').checked = false;
}
